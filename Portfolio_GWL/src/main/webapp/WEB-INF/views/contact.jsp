				...
				<div class="inner">
					...
					<div class="table-wrapper">
						...
						<div style="float: right; margin-right:3%">
							<a href="/Portfolio/contact/readMarked?page=1" class="button primary small">Mark
								List</a>
						</div>
						<div style="float: right;margin-right:32%;font-size:110%">
							<ul class="pagination">
								<li><a href="/Portfolio/contact?page=${page==1?page:page-1}" class="button small">Prev</a></li>
								<c:forEach var="i" begin="1" end="${len%5==0?len/5:len/5+1}">
									<li><a href="/Portfolio/contact?page=${i}" class="page">${i}</a></li>
								</c:forEach>
								<li><a href="/Portfolio/contact?page=${page==(len%5==0?len/5:(len-(len%5))/5+1)?page:page+1}" class="button small">Next</a></li>
							</ul>
						</div>					
					</div>
				</div>
